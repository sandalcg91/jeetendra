...
public class CustDataWhere {
		...
		public static void sqlWhereClouse()
		{
			System.out.println("SQL Where clouse executed");
		...
		public static void hqlWhereClouse()
		{
			System.out.println("HQL Where Clouse executed");
			System.out.println("cid"+"  "+"firstname"+"  "+"lastname"+"  "+"Mobile"+"         "+"Address"+"      "+"City"+"  "+"pincode");
