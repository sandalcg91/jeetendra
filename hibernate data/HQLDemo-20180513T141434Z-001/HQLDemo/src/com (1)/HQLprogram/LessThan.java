...
public class LessThan {
		...
		public static void sqlLessThan()
		{
		...
		public static void hqlLessThan()
		{
			System.out.println("HQL Query executed (<)");
			System.out.println("cid"+"  "+"firstname"+"  "+"lastname"+"  "+"Mobile"+"         "+"Salary"+"   "+"Address"+"        "+"City"+"  "+"pincode");
			Query q = session.createQuery("from EmployeeDTO e where e.salary < 60000");
			List list = q.list();
