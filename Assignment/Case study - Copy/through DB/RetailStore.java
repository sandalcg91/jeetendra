...
/*	public int checkProductAvailability(String productName)
	...
	public double calculateNetAmout(int customerId, double discount)
	{
		try{
			// fetch booked id
			...
			String q1 = "select b_id, c_id, prodname, quantity from prod_cust_book where b_id =?";
