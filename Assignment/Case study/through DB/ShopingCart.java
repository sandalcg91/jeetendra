...
public class ShopingCart
{
	...
	//	String storename = "Spancer Home Appliances Shop";
		RetailStore rts = new RetailStore();
		...
		while(ch!=0 && ch<6)
		{
			switch(ch)
			{
				...
				case 4: System.out.print("Enter Booked id : ");
						...
						int custid = cobj.checkCustomerId(bcid);
						if(custid==bcid)
						{
							System.out.print("Enter product name : ");
							String bpnm = sc.next();
							...
							{
								System.out.println("------=====+++++----------+++++=====------");
								System.out.println("Your choice of product not available");
								System.out.println("------=====+++++----------+++++=====------");
							}
						}
						else
						{
							System.out.println("There is no any customer details available");
						}
